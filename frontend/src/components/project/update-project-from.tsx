...
import { useUpdateProject } from "@/features/project/api/use-update-project";
...
export default function UpdateProjectForm({
  ...
  const { mutateAsync: updateProject, isPending: loadingUpdate } =useUpdateProject(project.id);
        ...
        <Form {...form}>
          <form onSubmit={form.handleSubmit(onSubmit)}>
            ...
            <div className="flex items-center justify-between mt-7">
              <Button type="submit" size="lg" disabled={loadingUpdate}>

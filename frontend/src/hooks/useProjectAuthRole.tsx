...
export function useProjectAuthRole(projectId:number|string) {
  ...
  const [userProjectMembershipId, setUserProjectMembershipId] = useState<string | number | null>(null);
      ...
      try {
        ...
        if (decoded.exp && decoded.exp * 1000 < Date.now()) {
          ...
          if (member) {
            ...
            setIsProjectMember(member.roleInProject === "PROJECT_MEMBER" || member.roleInProject === "PROJECT_OWNER");

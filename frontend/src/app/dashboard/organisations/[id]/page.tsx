...
export default function OrganizationDetail() {
  ...
  if (error || data.isError)
    return <p className="text-red-500">Aucun organisateur trouvé</p>;
      ...
      <div>
        {isAdminOrOwner && (
          <div className="flex flex-row justify-between gap-4">
            {/* Texte "Project :" */}
            <div className="flex items-center font-bold text-xl">Project :</div>
        ...
        <div className="p-4">
          {projects && projects.length > 0 ? (
            ...
            <div className="flex flex-col items-center justify-center h-64 border-2 border-[#1D71B8] rounded-xl  p-6 shadow-md">
              ...
              <h3 className="text-2xl font-bold text-[#142D5C] mb-2 animate-pulse">
                Aucun projet
              </h3>
        ...
        <Card className="shadow-sm border-[#d6e6f2] rounded-xl">
          <CardContent className="p-3 text-center">
            <p className="text-sm mb-3">
              Toutes les informations liées à cette organisation seront
              supprimées.
            </p>
